...
public class Product {
    ...
    public String toString(){
        return "ID:" + id + " display_name: " + display_name + " packaging: " + "ean:" + ean+ packaging + " unit_price: " + getUnit_price()
                + " bulk_price: " + getBulk_price() + " reference_format: " + getReference_format() + " photo zoom: " + getZoom() + " regular: " + getRegural()
